...
-(NSString *)calculaAreaLateral
{
    ...
    [str appendString:[NSString stringWithFormat:@"Al = %f u²",self.base.raio * self.geratriz * 3.14]];
...
-(NSString *)calculaAreaTotal
{
    ...
    [str appendString:[NSString stringWithFormat:@"At = %f u²",self.base.raio * self.geratriz * 3.14 + self.base.raio * self.base.raio * 3.14]];
...
-(NSString *)calculaVolume
{
    ...
    [str appendString:[NSString stringWithFormat:@"Vc = %f u³",3.14 * ((self.base.raio * self.base.raio * self.altura)/3)]];
