...
-(NSString *)calculaAlturaEquilatero
{
    ...
    [str appendString:[NSString stringWithFormat:@"h = %g√3 u\n",(float)self.lado/2]];
...
-(NSString *)calculaAlturaIsosceles
{
    ...
    [str appendString:[NSString stringWithFormat:@"h² = %g\n",(float)(self.lado * self.lado) - ((self.base * self.base) / 4)]];
    [str appendString:[NSString stringWithFormat:@"h = √%g\n",(float)(self.lado * self.lado) - ((self.base * self.base) / 4)]];
    [str appendString:[NSString stringWithFormat:@"h = %g u",altura]];
...
-(NSString *)calculaAreaEquilatero
{
    ...
    [str appendString:[NSString stringWithFormat:@"A = %g√3 u²\n",(float)self.lado * self.lado / 4]];
...
-(NSString *)calculaAreaIsosceles
{
    ...
    [str appendString:[NSString stringWithFormat:@"A = %g/2\nA = %g u²",_base * altura, _base * altura / 2]];
