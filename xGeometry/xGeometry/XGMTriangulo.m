...
-(NSString *)calculaAlturaEquilatero
{
    ...
    [str appendString:[NSString stringWithFormat:@"h = %.3f√3 u\n",(float)self.lado/2]];
...
-(NSString *)calculaAlturaIsosceles
{
    ...
    [str appendString:[NSString stringWithFormat:@"h² = %.3f\n",(float)(self.lado * self.lado) - ((self.base * self.base) / 4)]];
    [str appendString:[NSString stringWithFormat:@"h = √%.3f\n",(float)(self.lado * self.lado) - ((self.base * self.base) / 4)]];
    [str appendString:[NSString stringWithFormat:@"h = %.3f u",altura]];
...
-(NSString *)calculaAreaEquilatero
{
    ...
    [str appendString:[NSString stringWithFormat:@"A = %.3f√3 u²\n",(float)self.lado * self.lado / 4]];
...
-(NSString *)calculaAreaIsosceles
{
    ...
    [str appendString:[NSString stringWithFormat:@"A = %.3f/2\nA = %.3f u²",_base * altura, _base * altura / 2]];
